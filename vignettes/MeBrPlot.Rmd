...
```{r yr88, fig.width=6.5, fig.height=2.25, out.width="98%"}
library(lattice)
...
ctl <- glmmTMBControl(optimizer=optim,
                      optArgs=list(method="BFGS"))
cm88.TMB <- glmmTMB(cbind(dead,total-dead)~Cultivar,
               family=betabinomial(link='logit'), 
               data=cm88)
cm88.glm <- glm(cbind(dead,total-dead)~Cultivar, 
               family=quasibinomial(link='logit'), 
               data=cm88)
cm89.TMB <- glmmTMB(cbind(dead,total-dead)~Cultivar, 
                   family=betabinomial(link='logit'), 
                   data=cm89)
...
obj <- glmmTMB(cbind(dead,total-dead)~1, control=ctl,      
