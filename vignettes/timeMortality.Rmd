...
obs <- 1:nrow(HawCon)
HawCon$obsINrep <- gpsWithin(obs, HawCon$rep)
...
```{r DHARMa-obs, fig.width=3.75, fig.asp=0.95, bot=-1, top=1.5, out.width="32%",  fig.align='center', fig.show="hold", message=FALSE, echo=FALSE, mar=c(3.1,3.1,2.6,1.1), fig.cap=cap3,eval=FALSE}
